...
- **Recorte máximo (usuario vía story-maker-45, 2026-09-24):** lectura por PDF y cambio por CLI (el encargo acepta «web o PDF»). **Congelados:** 026 frontend (E, 8/18 en `carril-e`, un paso a medias sin commitear) y 030 `report metrics` (J, sin pasos hechos; código a medias sin commitear en `../sm-j`). D queda congelado salvo 020-C15.
