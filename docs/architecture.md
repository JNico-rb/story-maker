...
| Alcance del frontend | SPA completa (acceso, mis novelas, entrevista, progreso, lectura, cambio) · lectura y cambio en la SPA, configuración por la CLI · solo PDF y CLI | El encargo pide en la web la lectura y el cambio desde la página, no la configuración; plazo; menos deriva que quitar la web | SPA con acceso (022), «mis novelas» mínima (023: lista con enlace a la lectura, destino del acceso; usuario, 2026-09-25), lectura (026) y cambio del lector (027); entrevista, confirmación del brief, lanzamiento y progreso por la CLI (§15.8). El resto de 023, 024, 025 y 028 fuera de alcance (usuario, 2026-09-24). En 027 se selecciona solo un fragmento: la lectura no expone los hechos y el encargo pide «un fragmento o un hecho»; la API admite los dos |
