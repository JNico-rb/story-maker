...
| Identidad de cada brief de eval en `evals table` (020) | Id de la novela · `Novel.title` con un slug fijo | Filas estables entre ejecuciones | `Novel.title` = `ejemplo`, `infantil`, `boda`, `adversarial` o `temporal`; `evals run` (020-C03) crea las novelas con ese título |
