...
| Prohibidas de nivel user de un brief de evals (020) | Nivel user del cliente de `--email` · un cliente por brief · nivel novela de la novela del brief | Cada brief representa a su propio cliente, pero los cinco comparten `--email`: en el nivel user, la lista de un brief (boda: «pantalla») se aplicaba a los otros cuatro y tumbó la ejecución 11 (`verification.md` §8, fila 9). Un cliente por brief dejaría la novela del brief 1 fuera de la cuenta de la revisión humana (usuario, 2026-09-25) | Nivel novela: `evals run` y `example` registran las `user_banned_terms` de un brief de `ejemplos/briefs/` como prohibidas de la novela de ese brief (020-C18) |
