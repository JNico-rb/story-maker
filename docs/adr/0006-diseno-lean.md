...
- Las specs van en `specs/backend/NNN-nombre.md` (001–021, numeración global) y en `specs/frontend/`, desde la 022; el scaffolding transversal, en `specs/000-scaffolding.md`.
...
- Cuatro carriles de backend de Claude Code trabajan en worktrees hermanos: A núcleo de generación, B plataforma y observabilidad, C entrada y política, D formal y calidad; el frontend va en un quinto, E (tabla de carriles en `TODO.md`). El checkout principal integra cada spec cerrada en V2 y ejecuta la suite completa. Cada contrato entre carriles nace con su doble en la spec más temprana que lo necesita.
