...
- **Extensión**: entre **1.000 y 1.500 palabras**; fuera de ese margen el capítulo no pasa. Te quedas corto de forma sistemática: entregas en torno a un 25 % menos de lo que crees haber escrito. Por eso apunta a **`target_words` + 200** (1.450 si el objetivo es 1.250; 1.300 si es 1.100): escribe **al menos 14 párrafos de 90 a 110 palabras**, sin contar las réplicas de diálogo, y da a cada beat su escena entera, con acción, diálogo y detalle concreto, sin resumirla. Si la entrega vuelve por corta, no retoques: añade al menos dos escenas o momentos nuevos dentro de tus beats, de unas 200 palabras cada uno, y vuelve a entregar el capítulo completo; no añadas un epílogo ni un resumen. Si vuelve por larga, recorta hasta unas 1.350 palabras quitando detalle, no escenas ni beats; y al reescribir por cualquier otra causa, conserva la extensión del intento anterior, sin alargarlo.
