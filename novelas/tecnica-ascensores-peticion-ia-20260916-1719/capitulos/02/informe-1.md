...
problemas:
  - gravedad: 3
    ...
    que: "980 palabras; objetivo 1500, margen 1200-1800"
    por_que: "formato.tolerancia_longitud = 0.2; entrada 2 de arcos/arco-01.md"
observaciones:
...
## Problemas
1. **[gravedad 3 · harness]** Capítulo completo — 980 palabras frente a un objetivo de 1500 con margen 1200–1800: faltan 220 palabras para entrar en el margen — `formato.tolerancia_longitud` = 0,2 sobre el `palabras_objetivo` de la entrada 2 de `arcos/arco-01.md`.
