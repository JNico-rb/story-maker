...
2. Lanza el subagente `implementador` con $ARGUMENTS, la ruta absoluta de este checkout y su rama (sonnet por defecto; para 006, 007, 012 y 014, con `model: opus`); o, si prefieres hacerlo en esta sesión, sigue sus pasos y sus límites tal cual.
