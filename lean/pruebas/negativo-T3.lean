...
def cronologia : Cronologia where
  ...
  eventos := [
    ...
    { id := 61, momento := ⟨3215, 3, 3, 12, 0⟩, capitulo := none, beat := none, lugar := 21, presentes := [⟨11, none⟩], tipo := .ordinario, analepsis := false },
    { id := 62, momento := ⟨3215, 3, 3, 12, 0⟩, capitulo := none, beat := none, lugar := 22, presentes := [⟨11, none⟩], tipo := .ordinario, analepsis := false },
    { id := 63, momento := ⟨3216, 4, 4, 12, 0⟩, capitulo := none, beat := none, lugar := 21, presentes := [⟨13, none⟩], tipo := .ordinario, analepsis := false },
    { id := 64, momento := ⟨3216, 4, 4, 12, 0⟩, capitulo := none, beat := none, lugar := 22, presentes := [⟨13, none⟩], tipo := .ordinario, analepsis := false }
  ]
