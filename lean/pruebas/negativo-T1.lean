...
def cronologia : Cronologia where
  ...
  eventos := [
    ...
    { id := 61, momento := ⟨3226, 4, 10, 12, 0⟩, capitulo := some 4, beat := some 1, lugar := 21, presentes := [], tipo := .ordinario, analepsis := false },
    { id := 62, momento := ⟨3226, 4, 10, 11, 0⟩, capitulo := some 4, beat := some 2, lugar := 21, presentes := [], tipo := .ordinario, analepsis := false },
    { id := 63, momento := ⟨3226, 6, 10, 12, 0⟩, capitulo := some 6, beat := some 1, lugar := 21, presentes := [], tipo := .ordinario, analepsis := false },
    { id := 64, momento := ⟨3226, 6, 10, 11, 0⟩, capitulo := some 6, beat := some 3, lugar := 21, presentes := [], tipo := .ordinario, analepsis := false }
  ]
